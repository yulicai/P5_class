...
代码通过p5线上编辑器上交<br>
图文介绍通过石墨文档上交<br>
并将两个链附在本页面中。 （ 将链接点击右上角Edit按键，编辑本页面，加入到每节课“作业上交”区域）<br>
1. 代码上交，[p5 线上编辑器链接](https://alpha.editor.p5js.org/)。
2. 博客/文字/图文
	在石墨文档自己的文件夹内，每节课后编辑一个简单的记录，包含：灵感介绍，作业完成效果图，过程中遇到的问题。
3. 视频
	如果线上编辑器和图文不能完整的将作品展现，需要用视频记录，上传云盘，并将视频链接链在石墨文档中。
***
...
2. 未来的畅想<br>
	...
	内容： 上完本次课程后，在现有的知识的基础上，觉得之后能把这个跟什么结合起来做一些什么创作。
